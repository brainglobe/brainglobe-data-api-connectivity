...
Region metadata (except for unique region identifiers) and connection metadata is entirely optional from a purely mathematical analysis of the connectivity data.
